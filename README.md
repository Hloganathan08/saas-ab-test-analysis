...
- `data/experiment_users.csv` — 5,738 user-level records
- `output/ab_test_results.png` — 4-chart dashboard
- `output/ab_test_summary.csv` — Key metrics summary
- `output/ab_test_users.csv` — Processed user data for BI tools
---
